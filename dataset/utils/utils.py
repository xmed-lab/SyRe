...
GCG_QUESTIONS = [
    'Could you please give me a detailed description of this image? Please respond with interleaved segmentation masks for the corresponding parts of the answer.',
    ...
    'Could you give a comprehensive explanation of what can be found within this image? Please output with interleaved segmentation masks for the corresponding phrases.',
    'Could you give me an elaborate explanation of this image? Please respond with interleaved segmentation masks for the corresponding phrases.',
    'Could you provide me with a detailed analysis of this image? Please output with interleaved segmentation masks for the corresponding parts of the answer.',
]
...
MED_SEG_QUESTIONS = [
    "Can you segment the {class_name} in this {modality} image? {description}",
    "Please segment {class_name} in this {modality} image. {description}",
    "What is {class_name} in this {modality} image? Please respond with segmentation mask. {description}",
    "What is {class_name} in this {modality} image? Please output segmentation mask. {description}",

    "Could you provide a segmentation mask for the {class_name} in this {modality} image? {description}",
    "Please identify and segment the {class_name} in this {modality} image. {description}",
    "Can you highlight the {class_name} in this {modality} image with a segmentation mask? {description}",
]

MED_SEG_QUESTIONS_DES = [
    "Can you segment the {class_name} in this {modality} image based on the following description? {description}",
    "Please segment {class_name} in this {modality} image based on the following description: {description}",
    "What is {class_name} in this {modality} image? Please respond with segmentation mask based on the following description: {description}",
    "What is {class_name} in this {modality} image? Please output segmentation mask based on the following description: {description}",

    "Could you provide a segmentation mask for the {class_name} in this {modality} image based on the following description? {description}",
    "Please identify and segment the {class_name} in this {modality} image based on the following description: {description}",
]
...
ANSWER_LIST_CLS = [
    "Sure, here is the <p> {class_name} </p> [SEG].",
    "Sure, the segmentation result of <p> {class_name} </p> is [SEG].",
    "<p> {class_name} </p> [SEG].",
]